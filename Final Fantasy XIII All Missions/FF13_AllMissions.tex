...
\titlepic{\includegraphics[width=\textwidth]{final_fantasy_xiii_logo_by_eldi13_d42h0oc}}
\begin{document}
\singlespacing
\maketitle
\tableofcontents
...
\begin{multicols}{2}
\input{sections/01_beginning.tex}
\input{sections/02_archylte_pt1.tex}
\input{sections/03_vallis_yaschas.tex}
\input{sections/04_archylte_pt2.tex}
\input{sections/05_mahhabara.tex}
\input{sections/06_taejins.tex}
\input{sections/07_oerba.tex}
\input{sections/08_chapter12.tex}
\input{sections/09_cradle.tex}
\input{sections/10_return.tex}
\input{sections/11_faultwarrens.tex}
\input{sections/12_cleanup.tex}
\input{sections/13_finale.tex}
\end{multicols}
