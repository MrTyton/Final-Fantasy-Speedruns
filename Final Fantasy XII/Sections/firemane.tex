...
\begin{enumerate}
	\item \cs
	\item Use \balthier\ first aid to keep him in place, then use \fran\ to \pickup{Leather Shield}{around the corner}. \leader{\balthier} to trigger the Flan Fight, then \leader{\fran}
\end{enumerate}
\begin{battle}{Flan}
	\begin{itemize}
