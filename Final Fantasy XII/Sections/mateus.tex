...
\begin{gambit}
	\begin{itemize}
		      \charactergambit{\vaan}{\gambitline{(Ally: Any)}{(Protect/Smelling Salt)}}{\gambitline[enemy]{(Foe: Nearest Visible)}{(Steal)}}
...
\begin{shop}{7\,500}
	...
	\buy{2x Mage's Hat; Equip, Red Cap \textit{if you didn't buy it before}; Equip, Briandine or Shielded Armor; whichever you didn't buy before}
...
\begin{enumerate}
	...
	\vaanf Traver on Guardian. \basch\ \pickup{Megalixir/Elixer}{nearby}. Check the Traveler Step Count, set Battle Speed to slowest.
