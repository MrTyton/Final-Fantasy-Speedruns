...
\begin{enumerate}[resume]
	...
	\item Leave village, \sd\ through forced encounters, \sd\ during cutscene, avoid statue and leave the area by going up. You get 2 Power Spheres from these tutorials.
\end{enumerate}
\begin{spheregrid}
	\begin{itemize}
