...
\usepackage{graphicx}
\title{FFX Any\% - \textcolor{Magenta}{Blitz Loss}}
\author{Mr.Tyton}
...
\begin{multicols}{2}
	...
	\input{Chapters_Blitz_Loss/moonflow.tex}
	\input{Chapters/guadosalam.tex}
	\input{Chapters_Blitz_Loss/thunderplains.tex}
	\input{Chapters_Blitz_Loss/macalaniawoods.tex}
	\input{Chapters_Blitz_Loss/lakemacalania.tex}
	\input{Chapters/bikaneldesert.tex}
	\input{Chapters_Blitz_Loss/home.tex}
	\input{Chapters_Blitz_Loss/airship.tex}
	\input{Chapters_Blitz_Loss/bevelle.tex}
	\input{Chapters_Blitz_Loss/viapurifico.tex}
	\input{Chapters_Blitz_Loss/highbridge.tex}
	\input{Chapters_Blitz_Loss/calmlands.tex}
	\input{Chapters_Blitz_Loss/mtgagazet.tex}
	\input{Chapters_Blitz_Loss/zanarkand2.tex}
	\input{Chapters_Blitz_Loss/airship2.tex}
	\input{Chapters_Blitz_Loss/insidesin.tex}
\end{multicols}
