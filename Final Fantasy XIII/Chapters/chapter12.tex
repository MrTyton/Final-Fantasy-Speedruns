...
\ifthenelse{\equal{\platformtype}{pc}}
	{ \input{./Chapters/chapter12-pc-anavatapa.tex} }
	{ \ifthenelse{\equal{\platformtype}{console}}
	  {\input{./Chapters/chapter12-console-anavatapa.tex}
	}
}
...
\begin{battle}[1:16]{(FORTISOL)Proudclad 1}
	\begin{itemize}
		\item \second
		      \begin{itemize}
...
\ifthenelse{\equal{\notetype}{snow_turtle}}
	{ \input{./Chapters/chapter12-snow-menu1.tex} }
	{ \ifthenelse{\equal{\notetype}{lightning_turtle}}
	  {\input{./Chapters/chapter12-lightning-menu1.tex}
	}
}
...
\end{upgrade}
\ifthenelse{\equal{\notetype}{snow_turtle}}
	{ \input{./Chapters/chapter12-snow-menu2.tex} }
	{ \ifthenelse{\equal{\notetype}{lightning_turtle}}
	  {\input{./Chapters/chapter12-lightning-menu2.tex}
	}
}
