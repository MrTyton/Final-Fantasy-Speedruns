		...
		\begin{itemize}
			\item \first
			      \begin{itemize}
				      ...
				      \item Hover Repeat on Pantheron D briefly ($\uparrow\uparrow$)
				      \item Execute Repeat on Pantheron B
				      \item Auto-battle Attack if any Pantheron survives
			      \end{itemize}
		\end{itemize}
		\itemdrop{6}{Fortisol}
	\end{battle}
...
\begin{battle}[0:20]{Pulsework Soldier Pre-Empt}
	\begin{itemize}
		...
		\item \first
		      \begin{itemize}
			      \item Auto-chain twice, shift as soon as Sazh and Vanille cast their third spell in the second string
		      \end{itemize}
		\item \third
		      \begin{itemize}
			      \item Hope will finish him off
		      \end{itemize}
	\end{itemize}
	\itemdrop{6}{Aegisol}
\end{battle}
		...
		\begin{itemize}
			...
			\item \fifth
			      \begin{itemize}
				      ...
				      \item Libra
				      \item Potion
				      \item Potion again if Sazh or Lightning is below 260HP
				      \item \stagger
			...
			\item \second
			      \begin{itemize}
				      \item Shift after Lightnings third attack (Vanille will Deshell).
			      \end{itemize}
			\item \first
			      \begin{itemize}
				      \item Auto-chain twice
...
\end{battle}
	...
	\end{battle}
	\pickup{Librascope}{side pathway at the Uhlan dodge}
	\begin{battle}[0:13]{PSICOM Tracker x2}
		\itemdrop{6}{Aegisol} \itemdrop{19}{Phoenix Down}
	\end{battle}

	Hit 25 Pulsework Soldiers in the minigame. Pattern: 4-all-4-all.
			      ...
			      \begin{itemize}
				      \item \textit{If Odin is targeting Lightning}
				            \begin{itemize}
					            ...
					            \item Auto-chain in Ullr's Shield only
				            \end{itemize}
	...
	\begin{battle}[0:25]{Pulsework Soldier x2 Pre-Empt}
		...
		\itemdrop{6}{Aegisol}
	\end{battle}
	\begin{battle}[0:20]{Bomb \& Pulsework Soldier (2) Pre-Empt}
		\begin{itemize}
			\item \second
			      \begin{itemize}
				      \item Bravery Sazh, shift immediately
			...
			\item \third
			      \begin{itemize}
				      \item Auto-battle
				      \item Auto-battle 1 Attack for duration if needed
				      \item Auto-battle 2 Attacks after stagger
			      \end{itemize}
			\item \first
			      \begin{itemize}
			      ...
			      \begin{itemize}
				      ...
				      \item \first
				            \begin{itemize}
					            ...
					            \item If both are self-destructing, Auto-battle 1 Attack multiple times to get distance.
				            \end{itemize}
			      \end{itemize}
		\end{itemize}
		\itemdrop{6}{Aegisol}
