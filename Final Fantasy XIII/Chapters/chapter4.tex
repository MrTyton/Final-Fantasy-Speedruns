	...
	\begin{battle}[0:38]{PSICOM Ranger x3 \& Uhlan x2}
		\begin{itemize}
			\item \second
			      \begin{itemize}
				      \item Auto-battle
				      \item Ruin \textit{if triggered Powerchain else} Ruin x2
			      \end{itemize}
			\item \fourth
			      \begin{itemize}
				      \item Auto-chain
				      \item Summon
				      \item Auto-chain
				      \item Target the other Uhlan and shift
			      \end{itemize}
			\item \fifth
			      \begin{itemize}
				      \item Auto-chain twice
			...
			\item \fourth
			      \begin{itemize}
				      ...
				      \item B - Thunderfall (possible to skip if chain on both is above 287.5\%)
				      \item Y - Zantetsuken
			      \end{itemize}
		\end{itemize}
