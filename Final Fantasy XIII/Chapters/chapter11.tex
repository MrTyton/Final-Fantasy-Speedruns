	...
	\begin{itemize}
		...
		\item \second
		      \begin{itemize}
			      ...
			      \item Target BK, after Vanille and Snow start switch to Megistotherian, Blitz, RAC Snow
		      \end{itemize}
		\item \fourth
		      \begin{itemize}
		      	  \item Libra
		...
		\begin{itemize}
			\item B\&W Outfitters
			      \begin{itemize}
				      ...
				      \item Buy
				            \begin{itemize}
					            \item Black Belt ($\rightarrow\uparrow$)
					            \item Warrior's Wristband x2 ($\uparrow\uparrow\uparrow\uparrow$)
				            \end{itemize}
			      \end{itemize}
			      ...
			      \begin{itemize}
				      \item Buy
				            \begin{itemize}
					            ...
					            \item Barbed Tail x72 (or 81 Wicked Fangs if good gil)
				            \end{itemize}
			      \end{itemize}
