...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \item Summon when he staggers (Auto-chain again to interrupt if Vanille is interrupted)
...
{\paradigmline{\com}{\rav}{\com}}
    ...
    \begin{itemize}
        ...
        \begin{itemize}
            ...
            \end{itemize}
            \item (Optional) Saboteur
            \begin{itemize}
                \item 12 nodes, HP +55
            \end{itemize}
            \item (If skipped above nodes) Medic
            \begin{itemize}
