...
\vfill
	...
	\begin{battle}[1:05]{Thermadon \& Vespid Soldier}
		\begin{itemize}
			\item \first
			      \begin{itemize}
	...
	\begin{battle}[0:43]{Bridge 2 - PSICOM Reaver\, PSICOM Huntress x2 \& PSICOM Destroyer}%@Tyton fix the comma
		\begin{itemize}
			\item \first
			      \begin{itemize}
